...
for psp in tables.paramspace_pts():
	...
	if params['inh']['eta'] == 2e-5 and params['sim']['motion'] == 'persistent':
		print params['inh']['eta']
		rawdata = tables.get_raw_data(psp)
		plot = plotting.Plot(params, rawdata)
		animation = animating.Animation(params, rawdata, start_time=0.0, end_time=400.0, step_factor=1)
		break
...
#   lambda: plot.plot_output_rates_from_equation(frame=100, spacing=3, fill=False),
...
# animation.animate_output_rates(save_path=False, interval=50)
