...
tables = snep.utils.make_tables_from_path('/Users/simonweber/localfiles/itb_experiments/learning_grids/2013-08-22-11h57m26s/experiment.h5')
t0 = time.time()
...
plot_list = [
  ...
  # lambda: plot.weight_evolution(syn_type='exc', time_sparsification=100, weight_sparsification=1),
