...
def get_plot_list(plot_class):
	...
	plot_list = [
		...
		lambda: plot_class.plot_output_rates_from_equation(frame=5e5, spacing=51, fill=True),
		lambda: plot_class.plot_output_rates_from_equation(frame=1e7, spacing=51, fill=True),
		lambda: plot_class.plot_output_rates_from_equation(frame=0.5e8, spacing=51, fill=True),
		lambda: plot_class.plot_output_rates_from_equation(frame=1e8, spacing=51, fill=True),
