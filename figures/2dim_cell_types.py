...
plt.contourf(X, Y, field, V, cmap=mpl.cm.viridis)
cbar = plt.colorbar()
cbar.set_ticks([])
ax = plt.gca()
ax.set_aspect('equal')
...
plt.savefig('/Users/simonweber/doktor/TeX/learning_grids/2dim_cell_types/colorbar_viridis.png',
			bbox_inches='tight', dpi=500, pad_inches=0.001)
# plt.show()