...
def eigenvalue(sign_exp, k, params, definition_by_cases=False):
    ...
    if definition_by_cases:
        ...
        second_exp[(kernel(k, params, 'exc') - kernel(k, params,
                                                      'inh') - term) < 0] = 1
    else:
        second_exp = 0
    f = (
            ...
            * (
                    ...
                    * np.sqrt(
                (kernel(k, params, 'exc') - kernel(k, params,
                                                   'inh') - term) ** 2
...
def grid_spacing_high_density_limit(params, varied_parameter=None,
    ...
    if varied_parameter is not None:
        ...
        if varied_parameter[1] == 'number_per_dimension':
            prms[varied_parameter[0]][
                varied_parameter[1]] = parameter_range.reshape(
                parameter_range.shape[0], 1)
    ...
    ret = (
        ...
        np.log(
             ...
             * np.atleast_2d(prms['inh']['number_per_dimension'])[:,
               0] ** n_exponent
             ...
             * np.atleast_2d(prms['exc']['number_per_dimension'])[:,
               0] ** n_exponent
...
if __name__ == '__main__':
    ...
    # gs = 2 * np.pi / get_max_k(2, k, params, varied_parameter=('inh',
    # 'sigma'),
