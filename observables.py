# Except for sum_difference_squared all other functions should be imported
# from the gridscore package.
...
############################# All deprecated #############################
###########################################################################
# NB: The conventional grid score and the head direction measures should be
# imported from the gridscore package. All correlogram based functions are
# now in correlogram.py and all head direction related functions are in
# head_direction.py
